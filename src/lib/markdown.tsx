  ...
  return (
    <div
      className={[
        ...
        '[&_li]:my-0.5',
        '[&_pre]:my-2 [&_pre]:p-3 [&_pre]:bg-background/60 [&_pre]:border [&_pre]:rounded-md [&_pre]:overflow-x-auto [&_pre]:text-xs',
        '[&_pre_code]:bg-transparent [&_pre_code]:p-0',
        '[&_code]:bg-background/60 [&_code]:px-1 [&_code]:py-0.5 [&_code]:rounded [&_code]:text-[0.9em] [&_code]:font-mono',
